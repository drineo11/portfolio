    ...
    <>
      <div className="skills-page" id="skills-page-id">
        ...
        <div className="skills-page__cards-wrapper">
          ...
          <div className="skills-page__card">
            <h2 className="skills-page__text">React Native</h2>
            <img className="skills-page__image" src={ReactNativeIcon} alt="" />
          </div>
          <div className="skills-page__card">
            <h2 className="skills-page__text">Python</h2>
            <img className="skills-page__image" src={PythonIcon} alt="" />
          </div>
          <div className="skills-page__card">
            <h2 className="skills-page__text">SQL</h2>
            <img className="skills-page__image" src={SQLIcon} alt="" />
          </div>
